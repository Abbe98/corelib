...
public class EdmMongoServerImpl implements EdmMongoServer {
     ...
     * Any required login credentials as well as connection options (like timeouts) should be set in advance in the
     * provided mongoClient
     * Used by from corelib.db embeddedMongoProvider (unit test usage) only
     *
     * @param mongoClient	mongoClient
     * @param databaseName	databaseName
     ...
     * @param createIndexes, if true then it will try to create the necessary indexes if needed
     */
    public EdmMongoServerImpl(String hosts,
                              String ports,
                              String databaseName,
                              String username,
                              String password,
...
//        LOG.info("[corelib.storage EdmMongoServer] Morphia datastore is created");
    ...
    public FullBean resolve(String id) {
        ...
        LOG.info("[corelib.storage EdmMongoServer] Unresolvable Europeana ID: {}", id);
        return null;
    }
    ...
    public String toString() {
        return "MongoDB: [Host: " + mongoClient.getAddress().getHost() + "]\n" + "[Port: " +
               mongoClient.getAddress().getPort() + "]\n" + "[DB: " + databaseName + "]\n";
    }
